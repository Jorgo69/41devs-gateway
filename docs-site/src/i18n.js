...
const translations = {
  fr: {
    ...
    demo: {
      ...
      subtitle: 'La vraie modal — aucun mock. Cliquez pour voir le flux complet.',
      event: 'AfriTech Summit 2026',
      date: 'Sam. 18 octobre 2026 · 09h00',
      location: 'Cotonou, Bénin',
      ticket: 'Billet VIP',
      price: '25 000 XOF',
      btnBuy: 'Acheter un billet',
      note: 'Mode démo — aucune transaction réelle.',
      seatsLeft: '12 places restantes',
    },
    snippets: {
  ...
  en: {
    ...
    demo: {
      ...
      subtitle: 'The real modal — no mock. Click to see the full flow.',
      event: 'AfriTech Summit 2026',
      date: 'Sat. October 18, 2026 · 9:00 AM',
