...
| **gateway.test.js** | createGateway retourne { openPayment }, openPayment retourne une Promise ; annulation (bouton Annuler ou croix) → rejet avec PAYMENT_CANCELLED_CODE |
